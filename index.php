...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/bootstrap.min.css">
		...
		<link rel="stylesheet" type="text/css" href="css/movies_slider.css?v=<?php echo time(); ?>">
  ...
  <body id="itemid-1">
    ...
    <!--Navbar Code - End-->
		...
		<?php
				...
				{
						$query = "SELECT A.movie_id, B.movie_name, B.trailer_url FROM tbl_carousel A, tbl_movies B WHERE A.movie_id = B.movie_id ORDER BY A.id DESC";
				...
				function make_slides($db)
				{
						...
						if(mysqli_num_rows($result)>0) {
							while($row = mysqli_fetch_array($result))
							{
									...
									$output .= '
									<img class="d-block w-100" src="img/'.$row['movie_id'].'-1.jpg" alt="'.$row["movie_name"].'" />
		...
		<div class="now_showing">
			...
			<div class="container" w>
					...
					<div class="owl-carousel owl-theme" style="padding: 0 70px;">
						...
						<div class="item">
							<div class="card">
								<a href="movie.php?movie_id=<?php echo $row_nowshowing['movie_id'];?>"><img src="img/<?php echo $row_nowshowing['movie_id'];?>.jpg" alt="img" class="card-img-top home-page__movie-img"></a>
								<div class="card-body">
									<a class="movie_name" href="movie.php?movie_id=<?php echo $row_nowshowing['movie_id'];?>" style=""><h5><?php echo $row_nowshowing['movie_name'] ?></h5></a>
									<a class="btn btn-booking btn-danger" href="buy_tickets.php?movieID=<?php echo $row_nowshowing['movie_id'] ?>" style="margin-top:25px;">Buy Tickets</a>
								</div>
							</div>
						</div>
